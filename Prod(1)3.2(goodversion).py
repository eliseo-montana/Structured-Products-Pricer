...
S0 = 494.95        # stock price on 9 Dec 2025

# put strikes + ask prices
# ===== Updated option chain from MarketWatch (Jan 15, 2027) =====
...
# Product / bank parameters (same spirit as PDF)
...
# ===== Step 1: PV of guaranteed amount (same formula as PDF) =====
T = T_days / 365.0
PV = g * N / math.exp(r * T)
...
# ===== Step 2: bank margin & option budget per share =====
...
# ===== Step 3: try all put–call combinations, check inequality =====
rows = []
...
if feasible_pairs.empty:
    ...
    # ===== Step 4: pick the combination with smallest spread =====
    ...
    # ===== Step 5: number of options (like last formula in the page) =====
    n = N / S0
    print(f"\nNumber of underlying shares (N/S0) = {n:.2f}")
    print("→ This is the quantity of each option to buy.\n")

    # ---------- BONUS: payoff plot using short PPPN formula ----------
    floor = g * N
